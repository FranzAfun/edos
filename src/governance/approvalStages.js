 ...
 *
 * Flow:
 * - ≤ 1,000: PENDING_TECH_REVIEW → PENDING_FO → APPROVED → READY_FOR_DISBURSEMENT → DISBURSED
 * - > 1,000: PENDING_TECH_REVIEW → PENDING_FO → PENDING_CEO → APPROVED → READY_FOR_DISBURSEMENT → DISBURSED
...
export const APPROVAL_STAGE_LABELS = {
  ...
  [APPROVAL_STAGES.READY_FOR_DISBURSEMENT]: "Ready for Disbursement",
  [APPROVAL_STAGES.DISBURSED]: "Disbursed",
...
export const APPROVAL_STAGE_BADGE_LABELS = {
  ...
  [APPROVAL_STAGES.APPROVED]: "APPROVED",
  [APPROVAL_STAGES.READY_FOR_DISBURSEMENT]: "READY",
  [APPROVAL_STAGES.DISBURSED]: "DISBURSED",
...
export const APPROVAL_STAGE_COLORS = {
  ...
  [APPROVAL_STAGES.READY_FOR_DISBURSEMENT]: semanticStatus.warning,
  [APPROVAL_STAGES.DISBURSED]: semanticStatus.success,
...
export function isTerminal(stage) {
  return (
    stage === APPROVAL_STAGES.READY_FOR_DISBURSEMENT ||
    stage === APPROVAL_STAGES.DISBURSED ||
...
export function isSuccessfulStage(stage) {
  return (
